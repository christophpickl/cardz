...
object Dating : Source {
    ...
    override val sentences = listOf(
        ...
        "Without thinking too much, complete the sentence: " +
            "'The problem with most of the people I've been on a date with is...'",
        ...
        "What character traits do you long to find in someone else and " +
            "would help you feel you have discovered a soulmate?",
        "With playfulness and generosity, point out to one another how you feel the other might be difficult to " +
            "live alongside (remembering that we're all difficult in some key ways).",
